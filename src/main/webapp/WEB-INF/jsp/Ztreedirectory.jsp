...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href=""><span
				class="glyphicon glyphicon-home"></span>资源管理器</a>
	...
	<div style="float: left;">
		id: <input id="txtId" type="text" value="" /><br /> 名字：<input
			id="txtAddress" type="text" value="" />
	</div>
			...
			<div class="col-lg-4">
				<div class="panel panel-primary">
					<div class="panel-body">
						<p>
							目录<input class="form-control" type="text" name="inputdir"
								id="inputdirid" value="">
						</p>
